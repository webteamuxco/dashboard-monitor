...
- [Features](apps/docs-site/docs/features.md) — feature folders catalog (blocks, kpis, issues, dashboard, config…)
...
│   │   │   ├── features/       # blocks · kpis · issues · dashboard · config · components · utils
