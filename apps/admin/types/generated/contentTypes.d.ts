...
export interface ApiMappedToolMappedTool extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'MappedTool';
    pluralName: 'mapped-tools';
    singularName: 'mapped-tool';
  };
  options: {
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    default_config: Schema.Attribute.Component<
      'config.project-default-config',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    mapped_tools: Schema.Attribute.Relation<
      'manyToMany',
      'api::mapped-tool.mapped-tool'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    tool_configuration: Schema.Attribute.DynamicZone<
      ['config.posthog-configuration', 'config.glitchtip-configuration']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStrategyStrategy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mapped_tool: Schema.Attribute.Relation<
      'manyToOne',
      'api::mapped-tool.mapped-tool'
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
